            ...
            <div class="info">
                ...
                <div class="crear" id="crear">
                    ...
                    <div class="crear_marca" id="crear_marca">
                        <div class="content_formMarca">
                            <div id="cerrar_ventanaMarca"><img class="cerrar1" src="../../img/cerrar.png" alt="Cerrar">
                            </div>
                ...
                <div class="crear_color" id="crear_color">
                    <div class="content_formColor">
                        <div id="cerrar_ventanaColor"><img class="cerrar1" src="../../img/cerrar.png" alt="Cerrar">
                        </div>
                        <h2 class="titulo_color">AGREGAR COLOR</h2>
                        <form action="../../php/crear_maqui/regis_color_maqui.php" class="formularioColor" method="POST"
                            autocomplete="off">
                            <input type="text" class="ti_color" name="agre_color" id="agre_color" placeholder="COLOR"
