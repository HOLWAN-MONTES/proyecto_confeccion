<?php
    ...
    if($_POST['env-marca']){
        ...
        if(!$query_m){
            echo '<script> alert ("Error al registrar la marca del insumo");</script>';
            echo '<script> window.location="../../users/administrador/admin.php" </script>';
        }
        else{
            echo '<script> alert ("Datos guardados correctamente al registrar la marca del insumo");</script>';
            echo '<script> window.location="../../users/administrador/admin.php" </script>';
        }
